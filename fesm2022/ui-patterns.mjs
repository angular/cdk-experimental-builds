...
export { T as TabListPattern, b as TabPanelPattern, a as TabPattern } from './tabs-Da_MpXu1.mjs';
...
export { RadioButtonPattern, RadioGroupPattern, convertGetterSetterToWritableSignalLike };
