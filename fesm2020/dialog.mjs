...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.0.0-rc.3", ngImport: i0, type: CdkDialogContainer, decorators: [{
      ...
      params: {
        ...
        exitAnimationDuration: _config.exitAnimationDuration
                    ...
                    type: Inject,
                    args: [DOCUMENT]
                }] }, { type: DialogConfig }]; }, propDecorators: { _ariaLabel: [{
                type: HostBinding,
...
Dialog.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.0-rc.3", ngImport: i0, type: Dialog, deps: [{ token: i1$1.Overlay }, { token: i0.Injector }, { token: DIALOG_REF }, { token: DIALOG_SCROLL_STRATEGY }, { token: Dialog, optional: true, skipSelf: true }, { token: i2.Location, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
