(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */
    var CdkTableScrollContainer = /** @class */ (function () {
        function CdkTableScrollContainer(_elementRef, _document, _directionality) {
        ...
        CdkTableScrollContainer.prototype.ngOnInit = function () {
            var _a;
            // Note that we need to look up the root node in ngOnInit, rather than the constructor, because
            // Angular seems to create the element outside the shadow root and then moves it inside, if the
            // node is inside an `ngIf` and a ShadowDom-encapsulated component.
            this._styleRoot = (_a = platform._getShadowRoot(this._elementRef.nativeElement)) !== null && _a !== void 0 ? _a : this._document.head;
        };
        ...
        CdkTableScrollContainer.prototype.stickyEndColumnsUpdated = function (_b) {
            var sizes = _b.sizes;
            this._endSizes = sizes;
            this._updateScrollbar();
        };
        CdkTableScrollContainer.prototype.stickyHeaderRowsUpdated = function (_b) {
            var sizes = _b.sizes;
            this._headerSizes = sizes;
            this._updateScrollbar();
        };
        CdkTableScrollContainer.prototype.stickyFooterRowsUpdated = function (_b) {
            var sizes = _b.sizes;
         ...
         */
        CdkTableScrollContainer.prototype._updateScrollbar = function () {
            var topMargin = computeMargin(this._headerSizes);
            var bottomMargin = computeMargin(this._footerSizes);
            var startMargin = computeMargin(this._startSizes);
            var endMargin = computeMargin(this._endSizes);
            if (topMargin === 0 && bottomMargin === 0 && startMargin === 0 && endMargin === 0) {
                this._clearCss();
                return;
            }
            var direction = this._directionality ? this._directionality.value : 'ltr';
            var leftMargin = direction === 'rtl' ? endMargin : startMargin;
            var rightMargin = direction === 'rtl' ? startMargin : endMargin;
        ...
        CdkTableScrollContainer.prototype._getStyleSheet = function () {
        ...
        CdkTableScrollContainer.prototype._applyCss = function (value) {
            this._clearCss();
            var selector = "." + this._uniqueClassName + "::-webkit-scrollbar-track";
            this._getStyleSheet().insertRule(selector + " {margin: " + value + "}", 0);
        };
        CdkTableScrollContainer.prototype._clearCss = function () {
            var styleSheet = this._getStyleSheet();
            if (styleSheet.cssRules.length > 0) {
                styleSheet.deleteRule(0);
            }
        };
        return CdkTableScrollContainer;
    }());
    CdkTableScrollContainer.decorators = [
        { type: core.Directive, args: [{
                    ...
                    providers: [
                        { provide: table.STICKY_POSITIONING_LISTENER, useExisting: CdkTableScrollContainer },
                    ],
                },] }
    ];
    CdkTableScrollContainer.ctorParameters = function () { return [
    ...
    function computeMargin(sizes) {
        ...
        try {
            ...
            try {
                if (sizes_1_1 && !sizes_1_1.done && (_b = sizes_1.return)) _b.call(sizes_1);
            }
     ...
     */
    var CdkTableScrollContainerModule = /** @class */ (function () {
        function CdkTableScrollContainerModule() {
        }
        return CdkTableScrollContainerModule;
    }());
    CdkTableScrollContainerModule.decorators = [
    ...
    exports.CdkTableScrollContainer = CdkTableScrollContainer;
    exports.CdkTableScrollContainerModule = CdkTableScrollContainerModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=cdk-experimental-table-scroll-container.umd.js.map
