...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var u=new t.InjectionToken("CdkComboboxPanel"),d=0,h=function(){function e(e,t){this._elementRef=e,this._parentPanel=t,this._role="dialog",this.id="cdk-combobox-popup-"+d++}return Object.defineProperty(e.prototype,"role",{get:function(){return this._role},set:function(e){this._role=e},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"firstFocus",{get:function(){return this._firstFocusElement},set:function(e){this._firstFocusElement=e},enumerable:!1,configurable:!0}),e.prototype.ngOnInit=function(){this.registerWithPanel()},e.prototype.registerWithPanel=function(){null==this._parentPanel?this._explicitPanel._registerContent(this.id,this._role):this._parentPanel._registerContent(this.id,this._role)},e.prototype.focusFirstElement=function(){this._firstFocusElement?this._firstFocusElement.focus():this._elementRef.nativeElement.focus()},e}();h.decorators=[{type:t.Directive,args:[{selector:"[cdkComboboxPopup]",exportAs:"cdkComboboxPopup",host:{class:"cdk-combobox-popup","[attr.role]":"role","[id]":"id",tabindex:"-1","(focus)":"focusFirstElement()"}}]}],h.ctorParameters=function(){return[{type:t.ElementRef},{type:p,decorators:[{type:t.Optional},{type:t.Inject,args:[u]}]}]},h.propDecorators={role:[{type:t.Input}],firstFocus:[{type:t.Input}],id:[{type:t.Input}],_explicitPanel:[{type:t.Input,args:["parentPanel"]}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var f,y=[l,p,h];(f=function f(){}).decorators=[{type:t.NgModule,args:[{imports:[o.OverlayModule],exports:y,declarations:y}]}],
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.CdkCombobox=l,e.CdkComboboxModule=f,e.CdkComboboxPanel=p,e.CdkComboboxPopup=h,e.PANEL=u,Object.defineProperty(e,"__esModule",{value:!0})}));