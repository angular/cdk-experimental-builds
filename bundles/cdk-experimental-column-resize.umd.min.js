...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.CdkColumnResize=k,e.CdkColumnResizeDefaultEnabledModule=D,e.CdkColumnResizeFlex=w,e.CdkColumnResizeModule=I,e.CdkDefaultEnabledColumnResize=O,e.CdkDefaultEnabledColumnResizeFlex=H,e.CdkFlexTableResizeStrategy=z,e.ColumnResize=m,e.ColumnResizeNotifier=v,e.ColumnResizeNotifierSource=y,e.ColumnSizeStore=M,e.FLEX_RESIZE_STRATEGY_PROVIDER=E,e.HeaderRowEventDispatcher=g,e.Resizable=A,e.ResizeOverlayHandle=N,e.ResizeRef=W,e.ResizeStrategy=_,e.TABLE_LAYOUT_FIXED_RESIZE_STRATEGY_PROVIDER=C,e.TableLayoutFixedResizeStrategy=R,e.ɵangular_material_src_cdk_experimental_column_resize_column_resize_a=S,e.ɵangular_material_src_cdk_experimental_column_resize_column_resize_b=P,Object.defineProperty(e,"__esModule",{value:!0})}));