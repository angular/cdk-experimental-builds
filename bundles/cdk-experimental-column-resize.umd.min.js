...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.CdkColumnResize=P,e.CdkColumnResizeDefaultEnabledModule=H,e.CdkColumnResizeFlex=w,e.CdkColumnResizeModule=D,e.CdkDefaultEnabledColumnResize=k,e.CdkDefaultEnabledColumnResizeFlex=O,e.CdkFlexTableResizeStrategy=R,e.ColumnResize=f,e.ColumnResizeNotifier=y,e.ColumnResizeNotifierSource=m,e.ColumnSizeStore=I,e.FLEX_RESIZE_STRATEGY_PROVIDER=C,e.HeaderRowEventDispatcher=v,e.Resizable=W,e.ResizeOverlayHandle=A,e.ResizeRef=M,e.ResizeStrategy=_,e.TABLE_LAYOUT_FIXED_RESIZE_STRATEGY_PROVIDER=x,e.TableLayoutFixedResizeStrategy=g,e.ɵangular_material_src_cdk_experimental_column_resize_column_resize_a=b,e.ɵangular_material_src_cdk_experimental_column_resize_column_resize_b=S,Object.defineProperty(e,"__esModule",{value:!0})}));