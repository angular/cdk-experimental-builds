...
class CdkCombobox {
    ...
    _keydown(event) {
        ...
        if (keyCode === DOWN_ARROW) {
            if (this.isOpen()) {
                ...
                (_a = this._doc.getElementById(this.contentId)) === null || _a === void 0 ? void 0 : _a.focus();
            }
    ...
    _getPanelContent() {
        var _a;
        const hasPanelChanged = this._panelTemplateRef !== ((_a = this._panelPortal) === null || _a === void 0 ? void 0 : _a.templateRef);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.0-next.15", ngImport: i0, type: CdkCombobox, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: i1.Overlay }, { type: i0.ViewContainerRef }, { type: i0.Injector }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.0-next.15", ngImport: i0, type: CdkComboboxPopup, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: CdkCombobox, decorators: [{
                        type: Inject,
                        args: [CDK_COMBOBOX]
                    }] }];
    }, propDecorators: { role: [{
